...
| ---- | ----------- | ------- |
| [Spring Boot 2.x to 3.x Migration](./spring-boot-migration.md) | Comprehensive guide to migrate Spring Boot 2.x applications to Spring Boot 3.x with Java 17+, Jakarta EE namespace changes, and Spring Security 6 updates. | [📥 Install](vscode://vscjava.migrate-java-to-azure/installTask?url=https://raw.githubusercontent.com/backwind1233/app-mod-my-tasks/main/spring-boot-migration.md&category=my-tasks) |
| [Migrate Java Application to Azure](./azure-migration.md) | End-to-end Azure migration planning including architecture design, service selection, cost optimization, and deployment strategies. | [📥 Install](vscode://vscjava.migrate-java-to-azure/installTask?url=https://raw.githubusercontent.com/backwind1233/app-mod-my-tasks/main/azure-migration.md&category=my-tasks) |
| [Security Vulnerability Analysis and Remediation](./security-vulnerability-fix.md) | Identify and fix security vulnerabilities (CVEs) by analyzing dependencies, assessing impact, and applying recommended patches. | [📥 Install](vscode://vscjava.migrate-java-to-azure/installTask?url=https://raw.githubusercontent.com/backwind1233/app-mod-my-tasks/main/security-vulnerability-fix.md&category=my-tasks) |
| [Monolith to Microservices Refactoring](./microservices-refactoring.md) | Transform monolithic applications into microservices using domain-driven design, API gateways, and event-driven architecture. | [📥 Install](vscode://vscjava.migrate-java-to-azure/installTask?url=https://raw.githubusercontent.com/backwind1233/app-mod-my-tasks/main/microservices-refactoring.md&category=my-tasks) |
| [Java Application Performance Optimization](./performance-optimization.md) | Analyze and optimize Java application performance through profiling, code optimization, database tuning, and JVM configuration. | [📥 Install](vscode://vscjava.migrate-java-to-azure/installTask?url=https://raw.githubusercontent.com/backwind1233/app-mod-my-tasks/main/performance-optimization.md&category=my-tasks) |
